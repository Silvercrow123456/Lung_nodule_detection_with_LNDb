...
def normalize(image):
     ...
     return image
#### Pipeline 3 extract images (median)
...
for n in nodules:
     ...
     if name in confirmed.index:
         ...
         cv2.imwrite(f'/content/train_jpg/median/LNDb-{lnd:04d}_finding{finding}_rad{rad}.jpg'.format(lnd=lnd,finding=finding,rad=rad), R)